...
private slots:
  ...
  void on_btnVFO_clicked();
  void on_btnRX_clicked();
  void on_btnTX_clicked();
  void on_btnOption_clicked();

  //Append Lines by KD8CEC for VFO Control Window
  void on_btnA1_clicked();
  void on_btnA2_clicked();
  void on_btnA3_clicked();
  void on_btnA4_clicked();
  void on_btnA5_clicked();
  void on_btnA6_clicked();
  void on_btnA7_clicked();
  void on_btnA8_clicked();
  void on_btnA9_clicked();
  void on_btnA0_clicked();
  void on_btnAPoint_clicked();
  void on_btnAEnt_clicked();
  void on_btnAUSB_clicked();
  void on_btnALSB_clicked();
  void on_btnACW_clicked();
  void on_btnAVfoAB_clicked();
  void on_btnAMem_clicked();
  void on_btnACancel_clicked();
  void on_btnAFreqDown_clicked();
  void on_btnAFreqUp_clicked();
  void on_hSlider1_sliderMoved(int position);
  void on_hSlider1_sliderPressed();
  void on_hSlider1_sliderReleased();
  void on_btnFreqStep_clicked();
  void on_btnCatConnect_clicked();
  void on_btnAVfoToMem_clicked();
  void on_btnMMCancel_clicked();
  void on_btnMM01_clicked();
  void on_btnMM02_clicked();
  void on_btnMM03_clicked();
  void on_btnMM04_clicked();
  void on_btnMM05_clicked();
  void on_btnMM06_clicked();
  void on_btnMM07_clicked();
  void on_btnMM08_clicked();
  void on_btnMM09_clicked();
  void on_btnMM10_clicked();
  void on_btnMM11_clicked();
  void on_btnMM12_clicked();
...
private:
  ...
  void inputVFOFreq(int inputValue);        //for QRP with RPI by KD8CEC
  void mmMemoryProcess(int memoryIndex);
