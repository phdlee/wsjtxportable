  ...
  m_n {0}
{
  ...
  ui->widePlot->setMaximumHeight(90);
...

  {
    ...
    ui->cbControls->setChecked(false);
  }

  //ui->controls_widget->setVisible(!m_settings->value("HideControls",false).toBool());
  ui->controls_widget->setVisible(false);
  ui->widePlot->setBinsPerPixel(6);
  ui->widePlot->setStartFreq(300);
...
void WideGraph::on_btnOption_clicked (bool checked)
{
